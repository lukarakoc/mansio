            ...
            <div class="col-sm-12 col-lg-8 right">
                <div class="colm dynamic-width">
                    <div class="box-img" style="height: 20%">
                        <h1 class="custom-text-design">The house is designed especially for a sculptor whose experience in the studio changes during the year. The position if the inner and outer walls is constantly changing. Thanks to the carefully designed mechanism the object is rotated depending on climatic conditions meeting the main problem that arises when mountain and Mediterranean climates colide. The house consists of seven individual units, steel cages, only two of which are fixed.</h1>
                    </div>
                    <div class="box-img">
                        <a href="{{asset('assets/images/arhitektura/NATIVE-MUSEUM/GLAVNA1.jpeg')}}" data-lightbox="example-1">
                            <img src="{{asset('assets/images/arhitektura/NATIVE-MUSEUM/GLAVNA1.jpeg')}}" alt="" class="w-100">
                        </a>
                    </div>
                    <div class="box-img">
                        <a href="{{asset('assets/images/arhitektura/NATIVE-MUSEUM/2.jpeg')}}" data-lightbox="example-1">
                            <img src="{{asset('assets/images/arhitektura/NATIVE-MUSEUM/2.jpeg')}}" alt="" class="w-100">
                        </a>
                    </div>
                </div>
            </div>
