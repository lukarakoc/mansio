        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-8 right">
                <div class="colm dynamic-width">
                    ...
                    <div class="box-img">
                        <a href="{{asset('assets/images/arhitektura/WINERY/vinarijaaa.jpg')}}" data-lightbox="example-1">
                            <img src="{{asset('assets/images/arhitektura/WINERY/vinarijaaa.jpg')}}" alt="" class="w-100">
                        </a>
                    </div>
{{--                    <div class="box-img">--}}
{{--                        <a href="{{asset('assets/images/arhitektura/WINERY/glavna-1.jpg')}}" data-lightbox="example-1">--}}
{{--                            <img src="{{asset('assets/images/arhitektura/WINERY/glavna-1.jpg')}}" alt="" class="w-100">--}}
{{--                        </a>--}}
{{--                    </div>--}}
                    <div class="box-img">
                        <a href="{{asset('assets/images/arhitektura/WINERY/vinarija.jpg')}}" data-lightbox="example-1">
                            <img src="{{asset('assets/images/arhitektura/WINERY/vinarija.jpg')}}" alt="" class="w-100">
                        </a>
                    </div>
                </div>
            </div>
