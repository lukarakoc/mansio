            ...
            <div class="col-sm-12 col-lg-8 right">
                <div class="colm dynamic-width">
                    <div class="box-img" style="height: 20%">
                        <h1 class="custom-text-design"></h1>
                    </div>
                    <div class="box-img">
                        <a href="{{asset('assets/images/arhitektura/VERTICAL-SUBMARINE-JAPAN/Glavni1.jpg')}}" data-lightbox="example-1">
                            <img src="{{asset('assets/images/arhitektura/VERTICAL-SUBMARINE-JAPAN/Glavni1.jpg')}}" alt="" class="w-100">
                        </a>
                    </div>
                    <div class="box-img">
                        <a href="{{asset('assets/images/arhitektura/VERTICAL-SUBMARINE-JAPAN/2.jpg')}}" data-lightbox="example-1">
                            <img src="{{asset('assets/images/arhitektura/VERTICAL-SUBMARINE-JAPAN/2.jpg')}}" alt="" class="w-100">
                        </a>
                    </div>
                    <div class="box-img">
                        <a href="{{asset('assets/images/arhitektura/VERTICAL-SUBMARINE-JAPAN/3.jpg')}}" data-lightbox="example-1">
                            <img src="{{asset('assets/images/arhitektura/VERTICAL-SUBMARINE-JAPAN/3.jpg')}}" alt="" class="w-100">
                        </a>
                    </div>
                </div>
            </div>
