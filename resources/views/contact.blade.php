...
@section('content')
    ...
    <section class="about contact">
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-5 right">
                <form style="">
                    <h1>”Your memories are worth the investment.”</h1>
                    <div class="form-group">
                        <label for="email">First & Last name</label>
                        <input type="email" class="form-control" name="name" id="name" aria-describedby="emailHelp"
                               placeholder="Enter first & last name" style="font-size: 11px; text-transform: uppercase;">
                        <span></span>
                    </div>
                    <div class="form-group">
                        <label for="email">Email address</label>
                        <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp"
                               placeholder="Enter email" style="font-size: 11px; text-transform: uppercase;">
                        <span></span>
                    </div>
                    <div class="form-group">
                        <label for="message">Message</label>
                        <textarea class="form-control" placeholder="Enter message" id="message"
                                  rows="4" name="message" style="font-size: 11px; text-transform: uppercase;"></textarea>
                        <span></span>
                    </div>
                    <div class="form-button">
                        <button type="button" id="sendMessage" onclick="sendEmail()" class="con-send btn btn-primary">Send</button>
                    </div>
